            ...
            if ($create_management) {
                if ($is_jmb) {
                    ...
                    if (isset($row['61']) && !empty($row['61'])) {
                        ...
                        if(!empty($row['61']['date'])) {
                            $jmb_date_formed = Carbon::parse($row['61']['date'])->format('Y-m-d');
                        } else {
                            $jmb_date_formed = Carbon::createFromFormat('d/m/Y', trim($row['61']))->format('Y-m-d');
                        }
                    }
                ...
                if ($is_mc) {
                    ...
                    if (isset($row['76']) && !empty($row['76'])) {
                        ...
                        if(!empty($row['76']['date'])) {
                            $mc_date_formed = Carbon::parse($row['76']['date'])->format('Y-m-d');
                        } else {
                            $mc_date_formed = Carbon::createFromFormat('d/m/Y', trim($row['76']))->format('Y-m-d');
                        }
                    }
                    // 77. First AGM Date
                    $mc_first_agm = '';
                    if (isset($row['77']) && !empty($row['77'])) {
                        ...
                        if(!empty($row['77']['date'])) {
                            $mc_first_agm = Carbon::parse($row['77']['date'])->format('Y-m-d');
                        } else {
                            $mc_first_agm = Carbon::createFromFormat('d/m/Y', trim($row['77']))->format('Y-m-d');
                        }
                    }
                    // 78. Name
                    $mc_name = '';
