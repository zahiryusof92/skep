...
return array(
    ...
    "menus" => array(
        ...
        "administration" => array(
            ...
            "memo_maintenance" => "Notice Maintenance",
            "rating" => "Rating",
            "form" => "Form",
            ...
            "memo_management" => "Notice Management",
        ...
        "master" => array(
            ...
            "memo_type_maintenance" => "Notice Type Maintenance",
            "land_title_maintenance" => "Land Title Maintenance",
            "developer_maintenance" => "Developer Maintenance",
            "liquidator_maintenance" => "Liquidator Maintenance",
            ...
            "add_memo_type" => "Add Notice Type",
            "add_land_title" => "Add land Title",
            "add_developer" => "Add Developer",
            "add_liquidator" => "Add Liquidator",
            "add_agent" => "Add Agent",
            ...
            "edit_memo_type" => "Edit Notice Type",
            "edit_land_title" => "Edit land Title",
            "edit_developer" => "Edit Developer",
            "edit_liquidator" => "Edit Liquidator",
            ...
            'add_complaint_category' => 'Add Complaint Category',
    ...
    "forms" => array(
        ...
        "upload_attend_meeting" => "Salinan Senarai Pemilik Yang Hadir Dan Bertandatangan",
        ...
        "upload_sworn_statement" => "Surat Akuan Bersumpah (Lampiran C)",
        ...
        "remove" => "Remove",
        "check" => "Check",
        "before_change" => "Before Changes",
        "after_change" => "After Changes",
        "memo_date" => "Notice Date",
        ...
        "date_finance_file" => "Date Finance File",
        "date_strata" => "Date Strata",
        ...
        "nama2" => "Owner Name 2",
        "ic_no2" => "IC No Owner 2",
        "email2" => "Email Owner 2",
        "phone_no2" => "Phone No Owner 2",
        "nama3" => "Owner Name 3",
        "ic_no3" => "IC No Owner 3",
        "email3" => "Email Owner 3",
        "phone_no3" => "Phone No Owner 3",
        "lawyer_name" => "Lawyer Name",
        "lawyer_address" => "Lawyer Address",
        "lawyer_fail_ref_no" => "Lawyer Fail Ref No",
        ...
        'sum_bill_air' => "Water Bills",
        'sum_bill_elektrik' => "Electricity Bills",
        'sum_caruman_cukai' => "Land Tax Contributions",
        'sum_utility' => 'Utility (lain-lain) Expenses',
        'sum_contract' => 'Contract Expenses',
        'sum_repair' => 'Repair Expenses',
        'sum_vandalisme' => 'Vandalisme Expenses',
        'sum_staff' => 'Staff Expenses',
        'sum_admin' => ' Admin Expenses',
        'parking_bay' => 'Parking Bay',
        'parking_area' => 'Parking Area (sqf)',
        'cob_letter' => 'COB Letter',
        'create' => 'Create',
        'edit' => 'Edit',
        ...
        "unit_name" => "Unit No",
        "receiver_address_1" => "Receiver Address Line 1",
        "receiver_address_2" => "Receiver Address Line 2",
        "receiver_address_3" => "Receiver Address Line 3",
        "receiver_address_4" => "Receiver Address Line 4",
        "receiver_address_5" => "Receiver Address Line 5",
        "management_address_1" => "Management Address Line 1",
        "management_address_2" => "Management Address Line 2",
        "management_address_3" => "Management Address Line 3",
        "management_address_4" => "Management Address Line 4",
        "management_address_5" => "Management Address Line 5",
        "from_address_1" => "Sender Address Line 1",
        "from_address_2" => "Sender Address Line 2",
        "from_address_3" => "Sender Address Line 3",
        "from_address_4" => "Sender Address Line 4",
        "from_address_5" => "Sender Address Line 5",
        ...
        'complaint' => [
            ...
            'under_investigation_1' => 'Under Investigation - Pending Officer',
            'under_investigation_2' => 'Under Investigation - Pending Complainant',
            'resolved' => 'Resolved',
            'received' => 'Received',
            'pending' => 'Pending',
        ],
    ...
    "errors" => array(
        ...
        "delete_not_allowed" => "Delete is only allowed when status is Pending.",
    ...
    "successes" => array(
        ...
        "memos" => array(
            "store" => "Notice added successfully!",
            "update" => "Notice updated successfully!",
            "destroy" => "Notice deleted successfully!",
            "submit" => "Notice submitted successfully!",
        ),
        "agents" => array(
        ...
        "liquidators" => array(
            "store" => "Liquidator added successfully!",
            "update" => "Liquidator updated successfully!",
            "destroy" => "Liquidator deleted successfully!",
            "submit" => "Liquidator submitted successfully!",
        ),
        ...
        "memo_types" => array(
            "store" => "Notice Type added successfully!",
            "update" => "Notice Type updated successfully!",
            "destroy" => "Notice Type deleted successfully!",
            "submit" => "Notice Type submitted successfully!",
        ),
        "nationalities" => array(
    ...
    'strata_meeting_documents' => array(
        'list_estrata' => 'Upload of Minutes (MPKL)',
        'list_legacy' => 'Upload of Minutes',
