                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group {{ $errors->has('name') ? 'has-danger' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="{{ trans('app.point_package.name') }}" value="{{ Input::old('name') ? Input::old('name') : $model->name }}">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group {{ $errors->has('points') ? 'has-danger' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="points" name="points" placeholder="{{ trans('app.point_package.points') }}" value="{{ Input::old('points') ? Input::old('points') : $model->points }}">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group {{ $errors->has('price') ? 'has-danger' : '' }}">
                                    ...
                                    <input type="text" class="form-control" id="price" name="price" placeholder="{{ trans('app.point_package.price') }}" value="{{ Input::old('price') ? Input::old('price') : $model->price }}">
