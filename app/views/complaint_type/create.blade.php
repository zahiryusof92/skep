                    ...
                    <div class="row padding-vertical-20">
                        <div class="col-lg-12">
                            ...
                            <form class="form-horizontal" method="POST"
                                action="{{ route('complaintCategory.complaintType.store', \Helper\Helper::encode($parent->id)) }}">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group {{ $errors->has('is_active') ? 'has-danger' : '' }}">
                                            ...
                                            <select id="is_active" name="is_active" class="form-control">
                                                ...
                                                <option value="1"
                                                    {{ Input::old('is_active') == '1' ? 'selected' : '' }}>
                                                    {{ trans('app.forms.yes') }}
                                                </option>
                                                <option value="0"
                                                    {{ Input::old('is_active') == '0' ? 'selected' : '' }}>
                                                    {{ trans('app.forms.no') }}
                                                </option>
                                            </select>
                                ...
                                <div class="form-actions">
                                    ...
                                    <button type="button" class="btn btn-default" id="cancel_button"
                                        onclick="window.location ='{{ route('complaintCategory.complaintType.index', \Helper\Helper::encode($parent->id)) }}'">
