...
<head>
    ...
    <link rel="apple-touch-icon" type="image/png" sizes="114x114"
        href="{{asset('assets/common/img/favicon.114x114.png')}}">
    <link rel="apple-touch-icon" type="image/png" sizes="144x144"
        href="{{asset('assets/common/img/favicon.144x144.png')}}">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/vendors/datatables/media/css/dataTables.bootstrap4.min.css')}}">
    ...
    <script
        src="{{ asset('assets/vendors/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js')}}">
    </script>
