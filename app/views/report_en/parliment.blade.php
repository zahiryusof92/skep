            ...
            <div class="invoice-block">
                <div class="row">
                    <table width="100%">
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{URL::action('PrintController@printParliment', $cob_id ? \Helper\Helper::encode($cob_id) : 'all')}}" target="_blank">
                ...
                <section class="panel panel-pad">
                    <div class="row padding-vertical-15">
                        <div class="col-lg-12">
                            <form action="{{ url('/reporting/parliment') }}" method="GET" class="form-horizontal">
                                <div class="row">
                                    <div class="col-md-5">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <button type="button" class="btn btn-default" id="cancel_button" onclick="window.location ='{{ URL::action("ReportController@parliment") }}'"">{{ trans('app.buttons.reset') }}</button>
                    ...
                    <div class="row padding-bottom-15">
                        <div class="col-lg-12">
                            <p>LAPORAN</p>
                            <table border="1" id="parliment_report_table" width="100%">
                                <thead>
                                    <tr>
                                        <th style="width:30%; text-align: center !important; vertical-align:middle !important;">COB</th>
                                        <th style="width:30%; text-align: center !important; vertical-align:middle !important;">PARLIMENT</th>
                                ...
                                <tbody>
                                    ...
                                    @if ($file['parliment'])
                                    @foreach ($file['parliment'] as $parliment)
                                    ...
                                    @if ($parliment['category'])
                                    @foreach ($parliment['category'] as $cat)
                                    ...
                                    <tr>
                                        ...
                                        <td rowspan="" style="text-align: center !important; vertical-align:middle !important;">{{ $parliment['name'] }}</td>
...
<script type="text/javascript">
    Highcharts.chart('chart', {
        ...
        title: {
            text: 'Jumlah berdasarkan parlimen'
        },
        xAxis: {
            categories: <?php echo json_encode($parlimentChart); ?>,
            title: {
                text: null
            }
        },
