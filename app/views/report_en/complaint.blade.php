            ...
            <div class="invoice-block">
                <div class="row">
                    <table width="100%">
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{URL::action('PrintController@printComplaint', $cob_id ? \Helper\Helper::encode($cob_id) : 'all')}}" target="_blank">
                ...
                <section class="panel panel-pad">
                    <div class="row padding-vertical-15">
                        <div class="col-lg-12">
                            <form action="{{ url('/reporting/complaint') }}" method="GET" class="form-horizontal">
                                <div class="row">
                                    <div class="col-md-5">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <button type="button" class="btn btn-default" id="cancel_button" onclick="window.location ='{{ URL::action("ReportController@complaint") }}'"">{{ trans('app.buttons.reset') }}</button>
