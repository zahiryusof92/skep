                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <select id="company" class="form-control select2">
                                                    @if (count($cob) > 1)
                                                        <option value="">{{ trans('app.forms.please_select') }}
                                                        </option>
                                                    @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="parliament" class="form-control select2">
                                                ...
                                                @foreach ($parliament as $parliaments)
                                                    <option value="{{ $parliaments->description }}">
                                                        {{ $parliaments->description }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            oTable = $('#filelist').DataTable({
                "bProcessing": true,
                "sAjaxSource": "{{ URL::action('ReportController@getStrataProfileV2') }}",
                "lengthMenu": [
                    [15, 30, 50],
                    [15, 30, 50]
                ],
