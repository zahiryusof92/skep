                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ trans('app.forms.unit_number') }}" id="unit_no" value="{{$tenant->unit_no}}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ trans('app.forms.no_petak') }}" id="no_petak" value="{{$tenant->no_petak}}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ trans('app.forms.no_petak_aksesori') }}" id="no_petak_aksesori" value="{{$tenant->no_petak_aksesori}}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ trans('app.forms.keluasan_lantai_petak') }}" id="keluasan_lantai_petak" value="{{$tenant->keluasan_lantai_petak}}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ trans('app.forms.keluasan_lantai_petak_aksesori') }}" id="keluasan_lantai_petak_aksesori" value="{{$tenant->keluasan_lantai_petak_aksesori}}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ trans('app.forms.unit_share') }}" id="unit_share" value="{{$tenant->unit_share}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ trans('app.forms.jenis_kegunaan') }}" id="jenis_kegunaan" value="{{$tenant->jenis_kegunaan}}">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ trans('app.forms.tenant_name') }}" id="tenant_name" value="{{$tenant->tenant_name}}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ trans('app.forms.ic_company_number') }}" id="ic_company_no" value="{{$tenant->ic_company_no}}">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ trans('app.forms.nama2') }}" id="nama2" value="{{$tenant->nama2}}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ trans('app.forms.ic_no2') }}" id="ic_no2" value="{{$tenant->ic_no2}}">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" placeholder="{{ trans('app.forms.address') }}" rows="3" id="address">{{$tenant->address}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" placeholder="{{ trans('app.forms.alamat_surat_menyurat') }}" rows="3" id="alamat_surat_menyurat">{{$tenant->alamat_surat_menyurat}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ trans('app.forms.phone_number') }}" id="phone_no" value="{{$tenant->phone_no}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="{{ trans('app.forms.email') }}" id="email" value="{{$tenant->email}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ trans('app.forms.caj_penyelenggaraan') }}" id="caj_penyelenggaraan" value="{{$tenant->caj_penyelenggaraan}}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ trans('app.forms.sinking_fund') }}" id="sinking_fund" value="{{$tenant->sinking_fund}}">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" placeholder="{{ trans('app.forms.remarks') }}" rows="3" id="remarks">{{$tenant->remarks}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-actions">
                                <?php if ($update_permission == 1) { ?>
                                    <button type="button" class="btn btn-own" id="submit_button" onclick="editTenant()">{{ trans('app.forms.submit') }}</button>
                                <?php } ?>
        ...
        if (error == 0) {
            $.ajax({
                ...
                data: {
                    ...
                    file_id: file_id,
                    id: '{{ \Helper\Helper::encode($tenant->id) }}'
                },
                beforeSend: function() {
