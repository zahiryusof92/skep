...
<div id="page-content" class="container">
    ...
    <p>2.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adalah dimaklumkan pihak Jabatan Pesuruhjaya Bangunan (COB) Majlis Perbandaran Selayang telah menerima aduan berhubung dengan kebocoran air di <strong>unit kediaman ({{ $cobLetter->unit_name }})</strong> yang telah meresap dan telah menjejaskan kehidupan <strong>di unit rumahnya</strong>.<br/>Oleh yang demikian, kami di Jabatan Pesuruhjaya Bangunan (COB) memohon perhatian sewajarnya dari pihak pengurusan untuk melakukan siasatan dan mengambil tindakan selanjutnya terhadap aduan tersebut pada unit yang terlibat. </p>
    ...
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.2&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Seksyen 21 (2)(d)</strong> – mendapatkan daripada mana-mana pemunya petak apa-apa jumlah wang yang dibelanjakan oleh <strong>badan pengurusan bersama (JMB)</strong> berkenaan dengan petak itu dalam mematuhi apa-apa notis atau perintah yang disebut dalam perenggan (1)(e); dan</p> 
