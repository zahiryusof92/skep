<?php
$old_prefix = 'util_old_';
$old_prefix2 = 'utilb_old_';
$old_prefix3 = 'utilab_old_';
?>
...
<div class="row padding-vertical-10">
    <div class="col-lg-12">
        ...
        <fieldset disabled>
            ...
            <div class="row">
                <table class="table table-sm borderless" id="old_dynamic_form_utility" style="font-size: 12px;">
                    <thead>
                        <tr>
                            <th width="5%">&nbsp;</th>
                    ...
                    <tbody>
                        ...
                        <tr id="utility_row{{ ++$countb }}">
                            ...
                            <td><input type="text" name="{{ $old_prefix2 }}name[]" class="form-control form-control-sm" value="{{ $item->name }}" {{ $item->is_custom ? '' : 'readonly' }}></td>
                            ...
                            <td><input type="currency" id="{{ $old_prefix2 . 'total_income_' . $countb }}" name="{{ $old_prefix2 }}total_income[]" class="form-control form-control-sm text-right" value="{{number_format($totalb_income, 2, '.', '') }}" readonly=""></td>
                        ...
                        <tr>
                            ...
                            <th><input type="currency" id="{{ $old_prefix3 . 'total_tunggakan' }}" class="form-control form-control-sm text-right" value="{{ number_format($total_tunggakan + $totalb_tunggakan, 2, '.', '') }}" readonly=""></th>
                            <th><input type="currency" id="{{ $old_prefix3 . 'total_semasa' }}" class="form-control form-control-sm text-right" value="{{ number_format($total_semasa + $totalb_semasa, 2, '.', '') }}" readonly=""></th>
                            <th><input type="currency" id="{{ $old_prefix3 . 'total_hadapan' }}" class="form-control form-control-sm text-right" value="{{ number_format($total_hadapan + $totalb_hadapan, 2, '.', '') }}" readonly=""></th>
                            <th><input type="currency" id="{{ $old_prefix3 . 'total_all' }}" class="form-control form-control-sm text-right" value="{{ number_format(($total_all + $totalb_all), 2, '.', '') }}" readonly=""></th>
                            <th><input type="currency" id="{{ $old_prefix3 . 'total_tertunggak' }}" class="form-control form-control-sm text-right" value="{{ number_format($total_tertunggak + $totalb_tertunggak, 2, '.', '') }}" readonly=""></th>
                            <td>&nbsp;</td>
                        </tr>
                    </tbody>
                </table>
