<?php
$old_prefix = 'maintenancefee_old_';
$old_prefix2 = 'singkingfund_old_';
?>
...
<div class="row padding-vertical-10">
    <div class="col-lg-12">
        ...
        <fieldset disabled>
            ...
            <div class="row">
                <table class="table table-sm borderless" id="old_dynamic_form_vandal_a" style="font-size: 12px;">
                    <thead>
                        <tr>
                            <th width="5%">&nbsp;</th>
            ...
            <div class="row">
                <table class="table table-sm borderless" id="old_dynamic_form_vandal_b" style="font-size: 12px;">
                    <thead>
                        <tr>
                            <th width="5%">&nbsp;</th>
                            <th width="40%" style="text-align: center;">PERKARA</th>
