        ...
        <section class="panel panel-style">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h6>
                            {{ trans('app.forms.file_no') }}: {{ $files->file_no }}
                        </h6>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <label class="form-control-label">
                                                                <span style="color: red;">*
                                                                    {{ trans('app.forms.mandatory_fields') }}</span>
                                                            </label>
                                                        </div>
                                                    </div>
            ...
            $("#submit_button").click(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.success == true) {
                            bootbox.alert(
                                "<span style='color:green;'>{{ trans('app.successes.file_movement.store') }}</span>",
                                function() {
                                    window.location =
