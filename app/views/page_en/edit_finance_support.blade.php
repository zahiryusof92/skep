                                        ...
                                        <div class="col-lg-12">
                                            <form id="documentSubmit" class="form-horizontal" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input id="name" class="form-control" type="text" value="{{$item->name}}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input id="date" class="form-control" type="text" value="{{ date('d/m/Y', strtotime($item->date)) }}">
                                                        <input type="hidden" name="mirror_date" id="mirror_date" value="{{ $item->date }}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input id="amount" class="form-control" placeholder="0.00" type="text" value="{{$item->amount}}">
...
<script>
    ...
    function submitEditFinanceSupport() {
        changes = false;
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('AdminController@submitUpdateFinanceSupport') }}",
                type: "POST",
                data: {
                    file_id: file_no,
                    date: date,
