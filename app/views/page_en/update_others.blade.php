                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <h4>{{ trans('app.forms.housing_scheme') }}</h4>

                                                        <?php if ($update_permission == 1) { ?>
                                                            <button class="btn btn-success margin-bottom-25" data-toggle="modal" data-target="#houseSchemeForm">
                                                                {{ trans('app.forms.add_housing_scheme') }} &nbsp;<i class="fa fa-plus-circle"></i>
                                                            </button>
                                                                    ...
                                                                    <form id="form_housing_scheme">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h4 class="modal-title">{{ trans('app.forms.add_housing_scheme') }}</h4>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group">
                                                                                            <label><span style="color: red;">*</span> {{ trans('app.forms.user') }}</label>
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    ...
                                                                                    <button id="submit_button_housing_scheme" class="btn btn-primary" type="submit">
                                                        ...
                                                        <div class="table-responsive">                                                            
                                                            <table class="table table-hover nowrap" id="housing_scheme_list" width="100%">
                                                                <thead>
                                                                    <tr>
