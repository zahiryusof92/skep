...
<div class="page-content-inner">
    <section class="panel panel-with-borders">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    <form class="form-horizontal" method="POST" action="{{ route('vendors.update', $model->id) }}">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group {{ $errors->has('name') ? 'has-danger' : '' }}">
                                    ...
                                    <input type="text" class="form-control" placeholder="{{ trans('app.directory.vendors.name') }}" id="name" name="name" value="{{ Input::old('name') ? Input::old('name') : $model->name }}"/>
                                    @if($errors->has('name'))
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group {{ $errors->has('address') ? 'has-danger' : '' }}">
                                    ...
                                    <textarea id="address" name="address" rows="4" class="form-control" placeholder="{{ trans('app.directory.vendors.address') }}">{{ Input::old('address') ? Input::old('address') : $model->address }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group {{ $errors->has('remarks') ? 'has-danger' : '' }}">
                                    ...
                                    <textarea id="remarks" name="remarks" rows="5" class="form-control" placeholder="{{ trans('app.directory.vendors.remarks') }}">{{ Input::old('remarks') ? Input::old('remarks') : $model->remarks }}</textarea>
