                    ...
                    <div class="col-lg-12">
                        ...
                        <form id="add_liquidator">
                            ...
                            <div class="form-actions">
                                ...
                                <button type="button" class="btn btn-own" id="submit_button" onclick="add()">{{ trans('app.forms.submit') }}</button>
                                <?php } ?>
...
<script>
    ...
    function add() {
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('SettingController@submitLiquidator') }}",
                type: "POST",
                data: {
                    name: name,
                    address1: address1,
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>{{ trans('app.successes.liquidators.store') }}</span>", function () {
