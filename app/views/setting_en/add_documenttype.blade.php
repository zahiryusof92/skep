                ...
                <div class="col-lg-12">
                    <form id="form_documenttype" class="form-horizontal" name="add_fileprefix">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-own" id="submit_button" onclick="submitDocumenttype()">{{ trans('app.forms.save') }}</button>
                            <?php } ?>
        ...
        if (error == 0) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>{{ trans('app.successes.document_types.store') }}</span>", function () {
