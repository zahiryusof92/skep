...
<div class="page-content-inner">
    <section class="panel panel-with-borders">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    <form id="form_insurance_provider" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="name" class="form-control" placeholder="{{ trans('app.forms.insurance_provider_name') }}" type="text">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-own" id="submit_button" onclick="submitInsuranceProvider()">{{ trans('app.forms.save') }}</button>
                            <?php } ?>
...
<!-- Page Scripts -->
<script>
    function submitInsuranceProvider() {
        ...
        if (error == 0) {
            $.ajax({
                url: "{{ URL::action('SettingController@submitInsuranceProvider') }}",
                type: "POST",
                data: {
                    name: name,
                    sort_no : sort_no,
