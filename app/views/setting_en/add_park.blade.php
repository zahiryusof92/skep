                ...
                <div class="col-lg-12">
                    <form id="add_fileprefix" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="description" class="form-control" placeholder="{{ trans('app.forms.park') }}" type="text">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_button" onclick="addPark()">{{ trans('app.forms.save') }}</button>
                            <?php } ?>
...
<script>
    ...
    function addPark() {
        ...
        if (dun.trim() == "") {
            $("#dun_error").html('<span style="color:red;font-style:italic;font-size:13px;">{{ trans("app.errors.select", ["attribute"=>"DUN"]) }}</span>');
        ...
        if (error == 0) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>{{ trans('app.successes.parks.store') }}</span>", function () {
