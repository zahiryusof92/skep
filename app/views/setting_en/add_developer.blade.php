                ...
                <div class="col-lg-12">
                    ...
                    <form id="add_developer">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_button" onclick="addDeveloper()">{{ trans('app.forms.submit') }}</button>
                            <?php } ?>
        ...
        if (error == 0) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>{{ trans('app.successes.developers.store') }}</span>", function () {
