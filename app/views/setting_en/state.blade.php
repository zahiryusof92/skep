            ...
            <section class="panel panel-pad">
                <div class="row padding-vertical-20">
                    <div class="col-lg-12">
                        ...
                        <button onclick="window.location = '{{ URL::action('SettingController@addState') }}'" type="button" class="btn btn-own">
                            {{ trans('app.buttons.add_state') }}
                        </button>
                        <br/><br/>
                        <?php } ?>
                        <table class="table table-hover nowrap table-own table-striped" id="state" width="100%">
                            <thead>
                                <tr>
