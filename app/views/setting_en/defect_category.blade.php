                ...
                <div class="row padding-vertical-20">
                    <div class="col-lg-12">
                        <?php if ($insert_permission) { ?>
                            ...
                            <br/><br/>
                        <?php } ?>
                        <table class="table table-hover nowrap table-own table-striped" id="defect_category" width="100%">
                            <thead>
                                <tr>
                                    <th style="width:70%;">{{ trans('app.forms.defect_category') }}</th>
...
<script>
    ...
    function inactiveDefectCategory(id) {
        $.ajax({
            url: "{{ URL::action('SettingController@inactiveDefectCategory') }}",
            type: "POST",
            data: {
                id: id
            },
    ...
    function activeDefectCategory(id) {
        $.ajax({
            url: "{{ URL::action('SettingController@activeDefectCategory') }}",
            type: "POST",
            data: {
                id: id
            },
    ...
    function deleteDefectCategory(id) {
        swal({
            ...
            $.ajax({
                url: "{{ URL::action('SettingController@deleteDefectCategory') }}",
                type: "POST",
                data: {
                    id: id
                },
