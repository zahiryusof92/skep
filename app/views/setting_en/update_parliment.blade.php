                    ...
                    <div class="col-lg-12">
                        <form id="update_parliment" class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input id="code" class="form-control" placeholder="{{ trans('app.forms.code') }}" type="text" value="{{ $parliment->code }}">
                            ...
                            <div class="form-actions">
                                ...
                                <button type="button" class="btn btn-own" id="submit_button" onclick="updateParliment()">{{ trans('app.forms.save') }}</button>
                                <?php } ?>
