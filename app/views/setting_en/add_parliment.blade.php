                ...
                <div class="col-lg-12">
                    <form id="add_fileprefix" class="form-horizontal" name="add_fileprefix">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="description" class="form-control" placeholder="{{ trans('app.forms.parliament') }}" type="text">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-own" id="submit_button" onclick="addParliment()">{{ trans('app.forms.save') }}</button>
                            <?php } ?>
        ...
        if (error == 0) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>{{ trans('app.successes.parliaments.store') }}</span>", function () {
