            ...
            <section class="panel panel-pad">
                <div class="row padding-vertical-20">
                    <div class="col-lg-12">
                        ...
                        <button onclick="window.location = '{{ URL::action('SettingController@addFormtype') }}'" type="button" class="btn btn-own">
                            {{ trans('app.buttons.add_form_type') }}
                        </button>
                        <br/><br/>
                        <?php } ?>
                        <table class="table table-hover nowrap table-own table-striped" id="formtype" width="100%">
                            <thead>
                                <tr>
