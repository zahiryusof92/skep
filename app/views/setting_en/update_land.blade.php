                    ...
                    <div class="col-lg-12">
                        <form id="update_land" class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input id="description" class="form-control" placeholder="{{ trans('app.forms.land_title') }}" type="text" value="{{$land->description}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <select id="code" class="form-control select2">
                                        ...
                                        <option value="{{ $value }}" {{($land->code == $value ? " selected" : "")}}>{{ $name }} ({{ $value }})</option>
                                        @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <select id="is_active" class="form-control">
                                        <option value="">{{ trans('app.forms.please_select') }}</option>
                                        <option value="1" {{($land->is_active==1 ? " selected" : "")}}>{{ trans('app.forms.active') }}</option>
                                        <option value="0" {{($land->is_active==0 ? " selected" : "")}}>{{ trans('app.forms.inactive') }}</option>
                                    </select>
                            ...
                            <div class="form-actions">
                                ...
                                <button type="button" class="btn btn-own" id="submit_button" onclick="updateLandTitle()">{{ trans('app.forms.save') }}</button>
                                <?php } ?>
        ...
        if (error == 0) {
            $.ajax({
                ...
                data: {
                    ...
                    code: code,
                    is_active: is_active,
                    id: "{{ \Helper\Helper::encode($land->id) }}"
                },
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>{{ trans('app.successes.lands.update') }}</span>", function () {
