        ...
        <div class="panel-body">
            <section class="panel panel-pad">
                <div class="row padding-vertical-20">
                    <div class="col-lg-12">
                        <form id="form_race" class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input id="name_en" class="form-control" placeholder="{{ trans('app.forms.race_name_en') }}" type="text">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input id="name_my" class="form-control" placeholder="{{ trans('app.forms.race_name_my') }}" type="text">
                            ...
                            <div class="form-actions">
                                <?php if ($insert_permission == 1) { ?>
                                    <button type="button" class="btn btn-own" id="submit_button" onclick="submitRace()">{{ trans('app.forms.save') }}</button>
                                <?php } ?>
