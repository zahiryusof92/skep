            ...
            <section class="panel panel-pad">
                <div class="row padding-vertical-20">
                    <div class="col-lg-12">
                        ...
                        <button onclick="window.location = '{{ URL::action('SettingController@addNationality') }}'" type="button" class="btn btn-own">
                            {{ trans('app.buttons.add_nationality') }}
                        </button>
                        <br/><br/>
                        <?php } ?>
                        <table class="table table-hover nowrap table-own table-striped" id="nationality" width="100%">
                            <thead>
                                <tr>
                                    <th style="width:70%;">{{ trans('app.forms.nationality') }}</th>
