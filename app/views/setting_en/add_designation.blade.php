                ...
                <div class="col-lg-12">
                    <form id="add_memo_type" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="description" class="form-control" placeholder="{{ trans('app.forms.designation') }}" type="text">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-primary" id="submit_button" onclick="addDesignation()">{{ trans('app.forms.save') }}</button>
                            <?php } ?>
        ...
        if (error == 0) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.trim() == "true") {
                        bootbox.alert("<span style='color:green;'>{{ trans('app.successes.designations.store') }}</span>", function () {
