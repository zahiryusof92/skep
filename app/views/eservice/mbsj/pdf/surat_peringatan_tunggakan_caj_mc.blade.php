@extends('eservice.mbsj.layout.pdf')
...
@section('page1')
    <table border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
        <tr>
            <td colspan="4" rowspan="2" style="text-align: left; vertical-align: top;">
                <img width="174" height="22"
                    src="{{ public_path('assets/common/img/eservice/mbsj/kita_selangor.jpg') }}" />
            </td>
        ...
        <tr>
            <td colspan="7" style="text-align: justify;">
                ...
                Mengikut Seksyen 52(1), Akta Pengurusan Strata 2013 (Akta 757), pembeli hendaklah membayar caj bagi
                penyenggaraan dan pengurusan harta bersama. Kegagalan tuan/puan menjelaskan yuran penyenggaraan tersebut
                akan membolehkan tindakan mahkamah di bawah Seksyen 78(2), ataupun penahanan harta alih di bawah Seksyen 79,
        ...
        <tr>
            <td colspan="7" style="text-align: justify;">
                ...
                Pihak tuan diingatkan bahawa menurut Seksyen 78(3), Akta 757
        ...
        <tr>
            <td colspan="7" style="text-align: justify;">
                ...
                Untuk makluman, pihak pengurusan bangunan akan memulakan tindakan di bawah Seksyen 78 & 79, Akta 757 ke atas
    ...
    @include('eservice.mbsj.component.footer', ['page_num' => 1, 'page_count' => 2])
@endsection
