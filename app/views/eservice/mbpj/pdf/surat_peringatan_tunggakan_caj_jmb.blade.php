    ...
    <table border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
        ...
        <tr>
            <td colspan="7" style="font-weight: bold; text-align: justify; font-style: italic;">
                <span style="padding-right: 2em;">&nbsp;</span>“setiap pembeli hendaklah membayar Caj, dan caruman kepada
                kumpulan wang penjelas, berkenaan dengan petaknya kepada badan pengurusan bersama bagi penyenggaraan dan
                pengurusan bangunan atau tanah yang dicadangkan untuk dipecah bahagi kepada petak-petak dan harta bersama di
                dalam suatu kawasan pemajuan.”
            </td>
        </tr>
        <tr>
            <td colspan="7">
        ...
        <tr>
            <td colspan="7" style="font-weight: bold; text-align: justify; font-style: italic;">
                <span style="padding-right: 2em;">&nbsp;</span>“pemunya petak hendaklah, dalam masa tempoh empat belas hari
                daripada penerimaan notis daripada badan pengurusan bersama,membayar Caj, dan caruman kepada kumpulan wang
                penjelas, kepada badan pengurusan bersama itu.”
            </td>
        </tr>
        <tr>
            <td colspan="7">
        ...
        <tr>
            <td colspan="7" style="text-align: justify;">
                ...
                diperuntukan dibawah Seksyen 34 dan Seksyen 35, Akta Pengurusan Strata 2013[Akta 757] iaitu:-
            </td>
        </tr>
        <tr>
            <td colspan="7">
        ...
        <tr>
            <td colspan="7" style="font-weight: bold; text-align: justify; font-style: italic;">
                <span style="padding-right: 2em;">&nbsp;</span>“Mana-mana pembeli atau pemunya petak yang, tanpa alasan yang
                munasabah, tidak mematuhi notis yang disebut dalam subseksyen (1) melakukan suatu kesalahan dan boleh,
                apabila disabitkan, <u>didenda tidak melebihi lima ribu ringgit</u> atau dipenjara selama tempoh tidak
                melebihi tiga tahun atau <u>kedua-duanya</u>, dan dalam hal suatu kesalahan berterusan, didenda selanjutnya
                tidak melebihi lima puluh ringgit bagi tiap-tiap hari atau sebagainya kesalahan itu berterusan selepas
                disabitkan.”
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="7" style="text-align: justify;">
                ...
                tersebut, sila hubungi pihak JMB. Sila abaikan surat peringatan ini jika pembayaran telah dilakukan.
            </td>
        </tr>
        <tr>
            <td colspan="7">
