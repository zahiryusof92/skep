...
class CreateResidentialBlockExtraDraftTable extends Migration {
	...
	public function up()
	{
		Schema::create('residential_block_extra_draft', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('residential_block_extra_draft');
	}
