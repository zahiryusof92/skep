...
class CreateManagementLiquidatorDraftsTable extends Migration {
	...
	public function up()
	{
		Schema::create('management_liquidator_drafts', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('management_liquidator_drafts');
	}
