                ...
                if (!empty($data) && $data->count()) {
                    ...
                    foreach ($data->toArray() as $row) {
                        if (!empty($row)) {
                            ...
                            if (!empty($file_no)) {
                                Queue::later(Carbon::now()->addSeconds($delay), ImportFile::class, array('row' => $row, 'company_id' => $company_id, 'status' => $status));
                                ...
                                //     $exist_file->year = $year;
                                //     $exist_file->is_active = $is_active;
                                ...
                                //         $house_scheme = HouseScheme::where('file_id', $exist_file->id)->first();
                                ...
                                //         $strata = Strata::where('file_id', $exist_file->id)->first();
                                //         if(empty($strata)) {
                                //             $strata = new Strata();
                                //         }
                                //         $strata->title = $strata_title;
                                ...
                                //                 $residential = Residential::where('file_id', $exist_file->id)->first();
                                ...
                                //                 $commercial = Commercial::where('file_id', $exist_file->id)->first();
                                //                 if(empty($commercial)) {
                                //                     $commercial = new Commercial();
                                //                 }
                                //                 $commercial->strata_id = $strata->id;
                                ...
                                //             $facility = Facility::where('file_id', $exist_file->id)->first();
                                //             if(empty($facility)) {
                                //                 $facility = new Facility();
                                //             }
                                //             $facility->strata_id = $strata->id;
                                ...
                                //         $management = Management::where('file_id', $exist_file->id)->first();
                                //         if(empty($management)) {
                                //             $management = new Management();
                                //         }
                                //         $management->is_jmb = $is_jmb;
                                ...
                                //                 $new_jmb = ManagementJMB::where('file_id', $exist_file->id)->first();
                                //                 if(empty($new_jmb)) {
                                //                     $new_jmb = new ManagementJMB();
                                //                 }
                                //                 $new_jmb->management_id = $management->id;
                                ...
                                //                 $new_mc = ManagementMC::where('file_id', $exist_file->id)->first();
                                //                 if(empty($new_mc)) {
                                //                     $new_mc = new ManagementMC();
                                //                 }
                                //                 $new_mc->management_id = $management->id;
                                ...
                                //                 $new_agent = ManagementAgent::where('file_id', $exist_file->id)->first();
                                //                 if(empty($new_agent)) {
                                //                     $new_agent = new ManagementAgent();
                                //                 }
                                //                 $new_agent->management_id = $management->id;
                                ...
                                //                 $new_others = ManagementOthers::where('file_id', $exist_file->id)->first();
                                //                 if(empty($new_others)) {
                                //                     $new_others = new ManagementOthers();
                                //                 }
                                //                 $new_others->management_id = $management->id;
                                ...
                                //         $monitor = Monitoring::where('file_id', $exist_file->id)->first();
                                //         if(empty($monitor)) {
                                //             $monitor = new Monitoring();
                                //         }
                                //         $monitor->pre_calculate = $precalculate_plan;
                                ...
                                //         $others_details = OtherDetails::where('file_id', $exist_file->id)->first();
