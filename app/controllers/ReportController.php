...
class ReportController extends BaseController
{
    ...
    {
        // Increase execution time and memory limit for large reports
        ...
        $query = Buyer::with(['file.company', 'file.strata', 'race'])
        ...
        $purchaser = $query->orderBy('company.short_name', 'ASC')
