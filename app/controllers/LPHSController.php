            ...
            for ($year = 2020; $year <= date('Y'); $year++) {
                foreach ($councils as $council) {
                    ...
                    for ($month = 1; $month <= 12; $month++) {
                        ...
                        $financeList[$month] = $finance ? 'Yes' : '';
                    }

                    Arr::set($result[$year], trans('Council'), $council->short_name);
                    Arr::set($result[$year], trans('Year'), $year);
                    Arr::set($result[$year], trans('Finance Jan'), $financeList[1]);
                    Arr::set($result[$year], trans('Finance Feb'), $financeList[2]);
                    Arr::set($result[$year], trans('Finance Mar'), $financeList[3]);
                    Arr::set($result[$year], trans('Finance Apr'), $financeList[4]);
                    Arr::set($result[$year], trans('Finance May'), $financeList[5]);
                    Arr::set($result[$year], trans('Finance Jun'), $financeList[6]);
                    Arr::set($result[$year], trans('Finance Jul'), $financeList[7]);
                    Arr::set($result[$year], trans('Finance Aug'), $financeList[8]);
                    Arr::set($result[$year], trans('Finance Sep'), $financeList[9]);
                    Arr::set($result[$year], trans('Finance Oct'), $financeList[10]);
                    Arr::set($result[$year], trans('Finance Nov'), $financeList[11]);
                    Arr::set($result[$year], trans('Finance Dec'), $financeList[12]);
                    ...
                    Arr::set($result[$year], trans('AGM'), $agm ? 'Yes' : '');
                    ...
                    Arr::set($result[$year], trans('AJK'), $ajk ? 'Yes' : '');
                    ...
                    Arr::set($result[$year], trans('Document'), $document ? 'Yes' : '');
                }
            }
        }

        return $this->result($result, $filename = 'Extract_Data_' . strtoupper($cob), 'excel');
    }
}
